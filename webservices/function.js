...
//  twilio credentials ...........................gagan 
// "twilio": {
//     "sid": "AC0d2d1b1c5451771ceae267078e6dc23c",
//     "auth_token": "47f40a9fb853be19603855af4e8f2962",
//     "number":"+17156021582"
//     },

const accountSid = 'AC0d2d1b1c5451771ceae267078e6dc23c';
const authToken = '47f40a9fb853be19603855af4e8f2962';
...
exports.jwt = (body, cb) => {
    ...
    let token = jwt.sign(body, "Mobiloitte")
...
exports.sendEmail = (email, subject, message, callback) => {
    console.log("in send email for forgot password ==> ", email, subject, message)
...
exports.sendMessage = (number, text, callback) => {
    client.messages.create({
        body: text,//'Your otp-  ' + "123642dfherw5",
        to: number,//'+917451919823', // Text this number
...
exports.sendHtmlEmail = (email, subject, message, link, cc, bcc , name, callback) => {
    console.log("email====>>",email,subject,message,link)
    var userName = name
